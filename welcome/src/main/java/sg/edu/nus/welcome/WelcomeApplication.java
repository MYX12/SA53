...
public class WelcomeApplication {
	...
	CommandLineRunner runner() {
		return args->{
			...
			Customer c1 = new Customer("star","ISS");
			Product p= new Product("headset","bluetooth enable",100.00);
			...
			ArrayList<Customer> c1list=(ArrayList)crepo.findCustomerByName("Xin");
